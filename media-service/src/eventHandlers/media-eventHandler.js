...
const handlePostDeleted = async(event) => {
    ...
    // in this handler we are bascially consuming the post delete event , so here we get posId,user,id,and medaiIDs from Delete Post Event

    const { postId, mediaIds } = event // this medai ids we are getting from elete post publish event  post have this all medias
    try {
